...
class Aydus_Visitorlog_Block_Adminhtml_Visitorlog_View_Tab_Url 
	extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection() 
    {
    	...
    	$select->join(
    			array('u'=>$prefix.'log_url'),
    			'main_table.visitor_id = u.visitor_id',
    			array('u.url_id','u.visit_time')
    	);
    	
    	$select->join(
    			array('i'=>$prefix.'log_url_info'),
    			'u.url_id = i.url_id',
    			array('i.url','i.referer')
    	);
